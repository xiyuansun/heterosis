...
&=\exp \left (c_n G\ov{y}_{.n} +  \sum_{g = 1}^G \left [ y_{g, n}( \e_{g, n} + \mu(n, \phi_g, \alpha_g, \delta_g)) \right ]  -\exp(c_n) \sum_{g = 1}^G \exp( \e_{g, n} + \mu(n, \phi_g, \alpha_g, \delta_g))- \frac{c_n^2}{2 \sigma_c^2} \right ) \\
\end{align*}

 $p(c_n) \propto \exp( -\frac{c_n^2}{2\sigma_c^2} + c_n
G\overline{y}_n e^c_n \sum_g \exp(e_{gn}+\mu_{g,k(n)}))$
...
=&  \exp \left ( \sum_{k(n) \ne 2} \left [ y_{g, n} (c_n + \e_{g, n} + \mu(n, \phi_g, \delta_g, \delta_g)) - \exp(c_n + \e_{g, n} + \mu(n, \phi_g, \delta_g, \delta_g)) \right ] \right . \\
& \qquad  \left .- I(\delta_g)\frac{(\delta_g - \theta_\delta)^2}{2 \sigma_\delta^2} \right ) \\
\end{align*}
