...
p \left ( \left . \frac{1}{\sigma_g^2} \ \right \rvert \  \cdots \right ) &= \text{Gamma} \left ( \left . \frac{1}{\sigma_g^2} \ \right \rvert  \ \text{shape} = \frac{N + d}{2}, \  \text{rate} = \frac{1}{2} \left ( d \cdot \tau^2 + \sum_{n  =1}^N \e_{g, n}^2 \right ) \right ) \\
...
p(\tau^2 \mid \cdots) &= \text{Gamma} \left ( \tau^2 \ \left \lvert \ \text{shape} =  a_\tau + \frac{Gd}{2} \right ., \ \text{rate} =  b_\tau + \frac{d}{2} \sum_{g = 1}^G \frac{1}{\sigma_g^2} \right ) \\
