...
& \qquad \qquad \qquad \tau^2 \sim \text{Gamma}(\text{shape} = a_\tau, \text{rate} = b_\tau) \\
...
p(\tau^2 \mid \cdots) &= \prod_{n = 1}^N \prod_{g = 1}^G \text{Inv-Gamma} \left ( \sigma_g^2 \mid \text{shape} = \frac{d \cdot \tau^2}{2}, \text{rate} = \frac{d}{2} \right ) \cdot \text{Gamma}(\text{shape} = a_\tau, \text{rate} = b_\tau) \\
...
\begin{align*}
p \left (\frac{1}{\sigma_g^2} \mid \cdots \right ) &= \prod_{n = 1}^N \text{N}(\e_{g, n} \mid 0, \sigma_g^2) \cdot \text{Gamma} \left ( \frac{1}{\sigma_g^2} \mid \text{shape} = \frac{d \cdot \tau^2}{2}, \text{rate} = \frac{d}{2} \right ) \\ 
&\propto \prod_{n = 1}^N \exp \left (- \frac{1}{ \sigma_g^2} \frac{\e_{g, n}^2}{2} \right ) \cdot \left ( \frac{1}{ \sigma_g^2} \right )^{\frac{d \tau^2}{2}} \exp \left (- \frac{d}{2} \frac{1}{ \sigma_g^2} \right ) \\
&=  \left ( \frac{1}{ \sigma_g^2} \right )^{\frac{d \tau^2}{2}}  \exp \left (- \frac{1}{\sigma_g^2} \left (  \frac{N \cdot d}{2} + \frac{1}{2} \sum_{n = 1}^N \e_{g, n}^2  \right )  \right ) 
\end{align*}
