...
&= D \exp \left ( C - \frac{B^2}{4A^2} \right ) \int \underbrace{\exp \left( -\frac{1}{2(1/2|A|)} \left (\alpha_g + \frac{B}{2A} \right )^2  \right ) d \alpha_g}_{\text{kernel of normal distribution (note: $A < 0$)}} \\
