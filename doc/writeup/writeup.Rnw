...
&= (2 \pi y_{g, n}! (\sigma_\alpha')^2)^{-1/2} \int \exp \left (-\frac{(i - \alpha_g)^2}{2} - i + \alpha_g - 1 + y_{g, n}(i - \alpha_g) - \frac{(\alpha_g - \theta_\alpha')^2}{2 (\sigma_\alpha)'^2} \right ) d \alpha_g \\
&=  (2 \pi y_{g, n}! (\sigma_\alpha')^2)^{-1/2} \int \exp \left ( -\frac{\alpha_g^2}{2 (\sigma_\alpha')^2} -\frac{\alpha_g^2}{2} + i \alpha_g + \frac{\theta_\alpha' \alpha_g}{(\sigma_\alpha')^2} - y_{g, n} \alpha_g + \alpha_g  \right . \\
& \left . \qquad - \frac{i^2}{2} + i y_{g, n} - i - \frac{(\theta_\alpha')^2}{2 (\sigma_\alpha')^2 } - 1 \right ) d \alpha_g \\
&=  \underbrace{(2 \pi y_{g, n}! (\sigma_\alpha')^2)^{-1/2}}_{D} \int \exp \left ( \underbrace{\left ( -\frac{1}{2 (\sigma_\alpha')^2} -\frac{1}{2} \right )}_A \alpha_g^2 + \underbrace{\left ( i  + \frac{\theta_\alpha'}{(\sigma_\alpha')^2} - y_{g, n}  + 1 \right )}_B \alpha_g  \right . \\
...
&= D \int \exp \left( A \left (\alpha_g + \frac{B}{2A} \right )^2 C - \frac{B^2}{4A^2} \right ) d \alpha_g \\
&= D \exp \left ( C - \frac{B^2}{4A^2} \right ) \int \underbrace{\exp \left( -\frac{1}{2(1/2|A|)} \left (\alpha_g + \frac{B}{2A} \right )^2  \right ) d \alpha_g}_{\text{kernel of a normal distribution (note: $A < 0$)}} \\
&= D \exp \left ( C - \frac{B^2}{4A^2} \right ) \left  (\frac{2 \pi }{ 2|A|} \right )^{1/2}
\end{align*}

\item $P(y_{g, n} \mid \alpha_g \ne 0, \ldots)$ is the same when $n$ is in treatment group 3 except that $B$ switches signs.
