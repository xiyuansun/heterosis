...
__host__ void copyHyperParms(Chain*, Chain*, Config*);
...
__host__ void lD(Chain*, Chain*, Config*, int);
...
__host__ void oneChain(Chain*, Chain*, Config*);
extern "C" { __host__ void mcmc(int*, char**); }

__global__ void updateDICprep_kernel1(Chain*);
__global__ void updateDICprep_kernel2(Chain*);
__host__ void updateDICprep(Chain*, Config*);
